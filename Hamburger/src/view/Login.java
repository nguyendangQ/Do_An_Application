...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(user != null) {
            javax.swing.JOptionPane.showMessageDialog(Login.this, "Đăng nhập thành công!");
            this.dispose();
        } else {
            javax.swing.JOptionPane.showMessageDialog(Login.this, "Tên đăng nhập hoặc mật khẩu không đúng!");
        }
